...
local function RenderIcon(IconName, VectorPos, Container)
    local Icon = Utils.Exists("Assets/EditorIcons/16/" .. IconName .. ".png") and "Assets/EditorIcons/16/" .. IconName .. ".png" or "Assets/EditorIcons/16/File_Not_Found.png"local Icon = Utils.DoesFileExist("Assets/EditorIcons/16/" .. IconName .. ".png") and "Assets/EditorIcons/16/" .. IconName .. ".png" or "Assets/EditorIcons/16/File_Not_Found.png"
